        ...
        [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.datatables.net/1.10.20/js/dataTables.bootstrap.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//cdn.datatables.net/1.10.20/css/dataTables.bootstrap.min.css',
                ],
            ],
        ],
        [
